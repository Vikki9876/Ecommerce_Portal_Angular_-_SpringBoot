...
public class CreateProductRequest {
    ...
    // Standardized naming to match your Service logic
    private String topLevelCategory;
    private String secondLevelCategory;
    private String thirdLevelCategory;

    // Added the actual field for Size
    ...
    public int getDiscountedPercent() { return discountedPercent; }
    // Fixed typo: setDiscountedPersent -> setDiscountedPercent
    public void setDiscountedPercent(int discountedPercent) { this.discountedPercent = discountedPercent; }
